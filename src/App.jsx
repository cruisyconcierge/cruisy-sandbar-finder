        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <nav className="text-xs font-medium text-gray-400 flex items-center gap-1 mt-1">
                <a href="https://cruisytravel.com" className="hover:text-cyan-600 transition">Home</a>
                <span>/</span>
                <span className={`transition cursor-pointer ${currentView === 'home' ? 'text-cyan-600 font-bold' : 'hover:text-cyan-600'}`} onClick={() => setCurrentView('home')}>Sandbar Finder</span>
                {currentView === 'saved' && (
                  <>
                    <span>/</span>
                    <span className="text-cyan-600 font-bold">My Stash</span>
                  </>
                )}
              </nav>
            </div>
